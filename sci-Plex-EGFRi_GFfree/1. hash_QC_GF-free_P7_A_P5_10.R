...
cds <- readRDS("raw_data/cds_precell_prehash-P7-A-P5-10.RDS")
hash <- read_tsv("raw_data/hashTable-P7-A-P5-10.out", col_names = c("sample", "cell_ID", "oligo", "hash_umis"))
...
saveRDS("sci-Plex-EGFRi-GFfree-cds-P7-A-P5-10.RDS")

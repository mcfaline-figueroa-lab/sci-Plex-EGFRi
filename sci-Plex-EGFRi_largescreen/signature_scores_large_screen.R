...
saveRDS(mean_adaptive_up, 
        "BTline_EGFRi_24hr_adaptive_resistance_upgenes_zscored_byline.RDS")
...
# ================================================================================
treatment_diff_test_results <- read_csv("supplementary_tables/supplementary_table_S4_large_EGFRi_screen_dose_DEG_fit_models_result.csv")
...
# ================================================================================
# APM machinery expression and enrichment by Transcriptional Drug Class
# ================================================================================
...
transcript_drug_groups <- read_csv("MrVI_visualization/binary_membership/SharedPDCL_MrVI_Drug_DRC_BinaryMembership_HierarchicalClusters_FDRfilt_largegroups_RG.csv") %>%
